            ...
            @foreach ($get as $a)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/admin/member/hapus/{{ $a->id }}" onclick="return confirm('Apakah anda yakin ingin menghapus member ini ?')" class="btn btn-sm btn-danger fs-15"><i class="bi-trash"></i> Hapus</a>
                    </td>
                </tr>
            @endforeach
        </table>
