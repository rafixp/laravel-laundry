...
--
-- Host: localhost    Database: db_praktikum_laravel
-- ------------------------------------------------------
...
CREATE TABLE `detail_transaksis` (
  ...
  CONSTRAINT `detail_transaksis_ibfk_1` FOREIGN KEY (`id_transaksi`) REFERENCES `transaksis` (`id`),
  CONSTRAINT `detail_transaksis_ibfk_2` FOREIGN KEY (`id_paket`) REFERENCES `pakets` (`id`)
...
CREATE TABLE `pakets` (
  ...
  CONSTRAINT `pakets_ibfk_1` FOREIGN KEY (`id_outlet`) REFERENCES `outlets` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  KEY `id_outlet` (`id_outlet`),
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`id_outlet`) REFERENCES `outlets` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-22 12:11:20
