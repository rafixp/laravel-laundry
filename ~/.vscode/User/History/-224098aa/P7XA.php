            ...
            @foreach ($get as $a)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/admin/outlet/hapus/{{ $a->id }}" onclick="confirm('Apakah anda yakin ingin menghapus outlet ini ?')" class="btn btn-sm btn-danger fs-15"><i class="bi-trash"></i> Hapus</a>
                    </td>
                </tr>
            @endforeach
        </table>
