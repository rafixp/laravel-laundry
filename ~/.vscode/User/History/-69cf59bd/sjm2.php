...
Route::get('/admin/member/tambahmember', [App\Http\Controllers\adminController::class, 'tambahmemberView']);
Route::post('/admin/member/tambahmember', [App\Http\Controllers\adminController::class, 'tambahmember']);
Route::get('/admin/member/edit/{}', [App\Http\Controllers\adminController::class, 'tambahmember']);
